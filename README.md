...
```
For an example file see [`e_coli_core/01_objective.tsv`](examples/results/e_coli_core/cobrapy/01_objective.tsv). For more information on how to simulate the FBA see https://cobrapy.readthedocs.io/en/latest/simulating.html.
...
...
```
See for instance: [`e_coli_core/02_fva.tsv`](examples/results/e_coli_core/cobrapy/02_fva.tsv). For more information: https://cobrapy.readthedocs.io/en/latest/simulating.html#Running-FVA
...
...
```
See for instance: [`e_coli_core/03_gene_deletion.tsv`](examples/results/e_coli_core/cobrapy/03_gene_deletion.tsv). For more information: https://cobrapy.readthedocs.io/en/latest/deletions.html
...
...
```
See for instance: [`e_coli_core/04_reaction_deletion.tsv`](examples/results/e_coli_core/cobrapy/04_reaction_deletion.tsv). For more information: https://cobrapy.readthedocs.io/en/latest/deletions.html
